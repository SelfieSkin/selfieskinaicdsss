...
RESPONSE FORMAT: You must return a single JSON object matching this schema exactly.
{
  ...
  "dangerZones": Array<{ "region": string, "x": number, "y": number, "radius": number, "risk": string }>,
...
export const SAMPLE_ANALYSIS_FEMALE = {
  ...
  sites: [
    { id: "fs1", label: "G1", region: "Glabella", muscle: "Procerus", muscleFunction: "Central depressor", x: 50, y: 38, doseOna: 4, actualDoseOna: 4, rationale: "Centralize to address medial brow descent." },
    { id: "fs2", label: "G2L", region: "Glabella", muscle: "Corrugator", muscleFunction: "Medial depressor", x: 44, y: 36, doseOna: 4, actualDoseOna: 4, rationale: "Address medial frown lines." },
    { id: "fs3", label: "F1", region: "Forehead", muscle: "Frontalis", muscleFunction: "Brow elevator", x: 45, y: 20, doseOna: 2, actualDoseOna: 2, rationale: "Upper forehead placement to maintain arch." }
  ],
  dangerZones: [
    { id: "fd1", region: "Periocular", x: 38, y: 40, radius: 3, risk: "Levator palpebrae risk." }
  ],
...
export const SAMPLE_ANALYSIS_MALE = {
  ...
  sites: [
    { id: "ms1", label: "G1", region: "Glabella", muscle: "Procerus", muscleFunction: "Strong depressor", x: 50, y: 42, doseOna: 8, actualDoseOna: 8, rationale: "Increased dose for male muscle mass." },
    { id: "ms2", label: "M1L", region: "Jaw", muscle: "Masseter", muscleFunction: "Mastication strength", x: 30, y: 75, doseOna: 15, actualDoseOna: 15, rationale: "Jawline contouring and bruxism." }
  ],
  dangerZones: [
    { id: "md1", region: "Supraorbital", x: 50, y: 35, radius: 5, risk: "Avoid feminized arch." }
  ],
